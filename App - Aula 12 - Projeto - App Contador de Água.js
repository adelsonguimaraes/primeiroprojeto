...
import { View, StyleSheet, ImageBackground, Text, Button } from 'react-native'; // importando componentes React-Native
  ...
  render() { // função de renderização para um componente component
    return (
      <View style={styles.body}>
        <ImageBackground source={require('./images/copoagua.jpg')} style={styles.bgimage}>
           <View>
              <View style={styles.infoArea}>
                ...
                <View style={styles.area}>
                  <Text style={styles.areaTitulo}>Consumidos</Text>
